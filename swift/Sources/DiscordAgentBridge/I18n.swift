...
public enum I18n {
    ...
    private static let ko: [String: String] = [
        ...
        "taskPanel.title": "📋 작업 목록 · {done}/{total}",
        "taskPanel.title.done": "✅ 작업 목록 · {total}/{total} 완료",
        "taskPanel.pin.deniedTitle": "📌 작업 목록을 고정할 수 없어요",
        "taskPanel.pin.denied": "작업 목록 패널을 채널 상단에 고정하려면 봇에게 **메시지 관리** 권한이 필요해요. 지금은 일반 메시지로 올립니다.\n\n서버 설정 → 역할 → 이 봇의 역할 → **메시지 관리**를 켜고 아래 버튼을 누르면 바로 고정됩니다.",
        "taskPanel.pin.reinvite": "또는 이 링크로 권한을 한 번에 부여할 수 있어요 (봇이 나갔다 들어오지 않고 권한만 갱신됩니다):\n{url}",
        "taskPanel.pin.recheck": "다시 확인",
        "taskPanel.pin.recheckOk": "고정했어요. 이제 채널 상단 📌에서 작업 목록을 볼 수 있어요.",
        "taskPanel.pin.recheckStillDenied": "아직 고정 권한이 없어요. **메시지 관리** 권한을 켠 뒤 다시 눌러주세요.",
        "taskPanel.pin.recheckNoPanel": "이 채널에는 아직 작업 목록 패널이 없어요.",
        "diff.thread.name": "🔍 변경 {n}개 파일",
        "diff.summary.title": "🔍 변경 내용 · {n}개 파일 · +{added} −{removed}",
        "diff.footer.uncommitted": "커밋 안 됨",
        "diff.select.placeholder": "파일 선택",
        "diff.select.placeholderPaged": "파일 선택 ({page}/{pages})",
        "diff.button.expandAll": "전부 펼치기",
        "diff.file.empty": "(diff 내용이 없어요)",
        "diff.notARepo": "이 폴더는 git 저장소가 아니라서 변경 내용을 볼 수 없어요.",
        "diff.noChanges": "커밋 안 된 변경이 없어요.",
        "diff.failed": "변경 내용을 가져오지 못했어요. 잠시 후 다시 시도하세요.",
        "diff.posted": "변경 {n}개 파일을 스레드에 올렸어요.",
        "diff.expired": "이 변경 목록은 만료됐어요. `/diff`를 다시 실행해주세요.",
    ...
    private static let en: [String: String] = [
        ...
        "taskPanel.title": "📋 Tasks · {done}/{total}",
        "taskPanel.title.done": "✅ Tasks · {total}/{total} done",
        "taskPanel.pin.deniedTitle": "📌 Can't pin the task list",
        "taskPanel.pin.denied": "Pinning the task panel to the top of this channel needs the **Manage Messages** permission. For now it stays a normal message.\n\nServer Settings → Roles → this bot's role → turn on **Manage Messages**, then press the button below.",
        "taskPanel.pin.reinvite": "Or grant it in one click with this link (the bot doesn't leave and rejoin — only its permissions are updated):\n{url}",
        "taskPanel.pin.recheck": "Check again",
        "taskPanel.pin.recheckOk": "Pinned. The task list is now under 📌 at the top of the channel.",
        "taskPanel.pin.recheckStillDenied": "Still not allowed to pin. Turn on **Manage Messages** and press this again.",
        "taskPanel.pin.recheckNoPanel": "This channel has no task panel yet.",
        "diff.thread.name": "🔍 {n} changed file(s)",
        "diff.summary.title": "🔍 Changes · {n} file(s) · +{added} −{removed}",
        "diff.footer.uncommitted": "uncommitted",
        "diff.select.placeholder": "Pick a file",
        "diff.select.placeholderPaged": "Pick a file ({page}/{pages})",
        "diff.button.expandAll": "Expand all",
        "diff.file.empty": "(no diff content)",
        "diff.notARepo": "This folder isn't a git repository, so there are no changes to show.",
        "diff.noChanges": "No uncommitted changes.",
        "diff.failed": "Couldn't read the changes. Please try again shortly.",
        "diff.posted": "Posted {n} changed file(s) in a thread.",
        "diff.expired": "This change list has expired. Run `/diff` again.",
